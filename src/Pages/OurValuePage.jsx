...
const OurValuePage = ({
  value,
  label = "Our Values",
  heading = "Why Choose Bitcoding Solutions?",
  description = "Bitcoding Solutions specializes in delivering scalable and innovative digital solutions tailored to your business needs.",
  buttonText = "Explore More",
  buttonLink = "/about",
}) => {
  const valuesToRender =
    Array.isArray(value) && value.length > 0 ? value : defaultValues;
