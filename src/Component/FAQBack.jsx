...
const FAQBack = ({ faq, index, toggleFAQ }) => {
  return (
    ...
    >
      {/* Question Row */}
      <div className="flex justify-between items-center px-6 py-5 capitalize">
        <h3
        ...
        <AiOutlineDoubleRight
          className={`text-[#1296df] text-xl transform transition-transform duration-300 ${
      ...
      <div
        className={`overflow-hidden transition-all duration-500 ease-in-out ${
          faq.open ? "max-h-60 opacity-100 px-6 pb-4" : "max-h-0 opacity-0"
        }`}
      >
